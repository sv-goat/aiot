...
def get_har_data():
    ...
    Notes:
    - This function is synchronous and intended to run on the ESP microcontroller.
    - It does NOT call any LLMs. The host/server should request these samples and run
      the classification (this matches `checkpoint2_llm_server.py`).
    """
